...
## Verification
JavaScript syntax, relative entry files, Katie password hashing, wrong-password rejection, direct-page gate, locking, both-key save/removal, service/access failover, backup reuse and quota-fallback paths were checked locally with simulated API responses. No real user API key was available for live generation testing. Browser visual/end-to-end QA was not run.
